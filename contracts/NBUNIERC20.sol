...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
        ...
        returns (uint256)
    {
        ...
        console.log(
            "7 minutes since start is",
            contractStartTimestamp.add(7 minutes),
            "Time now is",
            block.timestamp
        );
        return contractStartTimestamp.add(7 minutes).sub(block.timestamp);
    }
    ...
    function liquidityGenerationOngoing() public view returns (bool) {
        ...
        console.log(
            ...
            contractStartTimestamp.add(7 minutes) < block.timestamp
        );
        return contractStartTimestamp.add(7 minutes) > block.timestamp;
    }
    ...
    {
        require(
            contractStartTimestamp.add(8 minutes) < block.timestamp,
